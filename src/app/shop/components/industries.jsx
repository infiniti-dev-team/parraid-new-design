      ...
      <Container>
        <Row>
          <Col md={8} lg={7}>
            ...
            <p>
              Parraid delivers mission-critical technology to organizations operating across air, land, sea, and cyber domains. Our tactical communications systems, telemetry communication solutions, and deployable communication products empower customers to connect, monitor, and command with absolute confidence.
            </p>
          </Col>
        </Row>
        <Row>
